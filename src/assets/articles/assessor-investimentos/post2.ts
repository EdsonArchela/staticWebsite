export default `
    <h1>
      O que faz um Agente Autônomo de Investimentos ou Assessor de
      Investimentos?
    </h1>
    ...
    <h2>Qual a rotina de um assessor de investimentos?</h2>
    ...
    <p>
      ...
      relatórios das casas de análise como as fornecidas pela XP Investimentos
      (link) e a Eleven (link).
    </p>
    <p>
    ...
    <h2>O que fala a legislação?</h2>

    <p>
      A legislação que regula a atividade do assessor de investimentos é a
      instrução CVM 497
      (http://www.cvm.gov.br/legislacao/instrucoes/inst497.html). Nela se
    ...
    <p>
      Você pode conferir que seu assessor está devidamente registrado neste link
      (http://sistemas.cvm.gov.br/?aai).
    </p>
    ...
    <h2>Como o assessor é remunerado?</h2>
